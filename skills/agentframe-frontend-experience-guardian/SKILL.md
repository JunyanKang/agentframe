---
name: agentframe-frontend-experience-guardian
description: "Use when UI screens, frontend flows, forms, dashboards, charts, visual artifacts, accessibility, responsive behavior, interaction states, visual QA, or user-facing error recovery must be designed or reviewed. Never use outside its stated ownership boundary."
---
