---
name: agentframe-ci-guardian
description: "Use when CI, GitHub Actions, guard scripts, validation lanes, required checks, workflow permissions, PR automation, trusted/untrusted workflow boundaries, or handoff artifacts must be designed, audited, or corrected. Never use outside its stated ownership boundary."
---
