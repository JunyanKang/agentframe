---
name: agentframe-observability-guardian
description: "Use when logs, telemetry, metrics, traces, diagnostics, error reporting, health checks, support bundles, run metadata, redaction, or operational evidence must be designed or reviewed. Never use outside its stated ownership boundary."
---
