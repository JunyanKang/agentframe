---
name: agentframe-migration-guardian
description: "Use when data, configuration, API, repository layout, runtime, cache, generated artifact, deprecation, backfill, upgrade, downgrade, rollback, or compatibility-window migrations must be planned and verified. Never use outside its stated ownership boundary."
---
