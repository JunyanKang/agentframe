---
name: agentframe-release-manager
description: "Use when versions, changelogs, tags, GitHub releases, packages, installers, release assets, update channels, artifact provenance, release validation, rollback, or publication notes must be planned, verified, or published. Never use outside its stated ownership boundary."
---
