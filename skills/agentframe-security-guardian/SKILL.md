---
name: agentframe-security-guardian
description: "Use when authentication, authorization, secrets, permissions, sandboxing, shell execution, webhooks, sensitive data, input validation, or trusted/untrusted execution boundaries must be reviewed or changed. Never use outside its stated ownership boundary."
---
