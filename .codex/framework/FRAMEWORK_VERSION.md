...
## Purpose
Track AgentFrame version 0.4.0, semantic versioning policy, compatibility expectations, upgrade procedure, migration note requirements, and breaking change policy.
