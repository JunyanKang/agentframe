...
## Purpose
Track AgentFrame version 0.6.3, semantic versioning policy, compatibility expectations, upgrade procedure, migration note requirements, and breaking change policy.
