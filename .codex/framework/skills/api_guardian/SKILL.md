...
- Use when a task requires responsibility for public APIs, private APIs, experimental APIs, deprecated APIs, backward compatibility, semantic versioning, deprecation policy, migration guides, contract tests, and public/internal distinction.
...
- Do not use when the task is unrelated to api guardian responsibilities.

## Responsibilities
- Own and maintain public APIs, private APIs, experimental APIs, deprecated APIs, backward compatibility, semantic versioning, deprecation policy, migration guides, contract tests, and public/internal distinction.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for accidental public API changes, silent breaking changes, removal without deprecation, parameter semantic changes without docs, and return type changes without migration.
...
## Required Outputs
- Role-specific artifact covering public APIs, private APIs, experimental APIs, deprecated APIs, backward compatibility, semantic versioning, deprecation policy, migration guides, contract tests, and public/internal distinction.
...
## Forbidden Behaviors
- accidental public API changes, silent breaking changes, removal without deprecation, parameter semantic changes without docs, and return type changes without migration.
