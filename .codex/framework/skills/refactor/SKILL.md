...
## Handoff Rules
- Handoff to tester to prove behavior preservation.
- Handoff to reviewer after the refactor diff is ready.
- Handoff to design_guardian when the refactor changes module boundaries or dependency direction.
- Handoff to project_memory when technical debt, architecture notes, or risks changed.
...
- Coordinate with implementer only if a separate approved implementation task follows.
- Coordinate with compatibility_manager when preserved behavior includes compatibility guarantees.
