...
- Use when a task requires responsibility for public APIs, outputs, side effects, error semantics, configuration semantics, data model semantics, compatibility guarantees, complexity reduction, duplication removal, risk assessment, and rollback.
...
- Do not use when the task is unrelated to refactor responsibilities.

## Responsibilities
- Own and maintain public APIs, outputs, side effects, error semantics, configuration semantics, data model semantics, compatibility guarantees, complexity reduction, duplication removal, risk assessment, and rollback.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for adding features, changing behavior, changing public APIs, changing persistence format, modifying unrelated modules, and hiding behavior changes as cleanup.
...
## Required Outputs
- Role-specific artifact covering public APIs, outputs, side effects, error semantics, configuration semantics, data model semantics, compatibility guarantees, complexity reduction, duplication removal, risk assessment, and rollback.
...
## Forbidden Behaviors
- adding features, changing behavior, changing public APIs, changing persistence format, modifying unrelated modules, and hiding behavior changes as cleanup.
