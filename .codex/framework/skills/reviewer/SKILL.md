...
## Handoff Rules
- Handoff to implementer when fixes are required.
- Handoff to tester when validation is missing or weak.
- Handoff to documenter when documentation gaps are found.
- Handoff to design_guardian for architecture drift.
- Handoff to api_guardian, configuration_manager, compatibility_manager, data_model_guardian, plugin_architect, or reproducibility_guardian for surface-specific risks.
- Handoff to project_memory when review findings change durable project state or risk records.
...
- Coordinate with tester for validation gaps.
