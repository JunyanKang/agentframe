# Reproducibility Guardian Skill

## Mission
Ensure work can be repeated, audited, and debugged.

## When To Use This Skill
- Use when a task requires responsibility for deterministic behavior where possible, random seed handling, dependency capture, environment capture, parameter capture, input/output traceability, logging, provenance, command recording, output validation, and result versioning.
...
- Do not use when the task is unrelated to reproducibility guardian responsibilities.

## Responsibilities
- Own and maintain deterministic behavior where possible, random seed handling, dependency capture, environment capture, parameter capture, input/output traceability, logging, provenance, command recording, output validation, and result versioning.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for hidden randomness, undocumented parameters, outputs without required provenance, undocumented environment-dependent behavior, non-repeatable workflows without warning, and silent fallback behavior that changes results.
...
## Required Outputs
- Role-specific artifact covering deterministic behavior where possible, random seed handling, dependency capture, environment capture, parameter capture, input/output traceability, logging, provenance, command recording, output validation, and result versioning.
...
## Forbidden Behaviors
- hidden randomness, undocumented parameters, outputs without required provenance, undocumented environment-dependent behavior, non-repeatable workflows without warning, and silent fallback behavior that changes results.
