...
## Handoff Rules
- Handoff to specification when reproducibility requirements must constrain implementation.
- Handoff to implementer after provenance, parameters, and validation behavior are clear.
- Handoff to tester for repeatability and output validation checks.
- Handoff to documenter for reproducibility instructions and provenance docs.
- Handoff to reviewer for final reproducibility risk review.
- Handoff to project_memory when reproducibility assumptions or known limits change.
...
- Coordinate with configuration_manager when parameters or environment settings affect repeatability.
- Coordinate with compatibility_manager when dependency or runtime changes affect reproducibility.
