# Frontend Experience Guardian Checklist

## Pre-Flight Checklist
- Confirm this skill is the right role for the task.
- Read applicable instructions and source-of-truth files.
- Identify affected files, owners, contracts, validation commands, and human-review gates.
- Inspect current behavior before recommending changes.
...
- Use established project patterns before adding new mechanisms.
...
- No public API, configuration, data model, compatibility, release, security, CI, dependency, frontend, or governance policy changed silently.
