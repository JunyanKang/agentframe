...
## Mission
Create and maintain system-level design without writing implementation code.

## When To Use This Skill
- Use when a task requires responsibility for system architecture, module boundaries, dependency direction, public interfaces, data flow, control flow, extension points, integration points, risk analysis, non-functional requirements, and tradeoffs.
...
- Do not use when the task is unrelated to architect responsibilities.

## Responsibilities
- Own and maintain system architecture, module boundaries, dependency direction, public interfaces, data flow, control flow, extension points, integration points, risk analysis, non-functional requirements, and tradeoffs.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for implementing features, making unreviewed API changes, adding dependencies without justification, bypassing architecture, mixing unrelated layers, and creating circular dependencies.
...
## Required Outputs
- Role-specific artifact covering system architecture, module boundaries, dependency direction, public interfaces, data flow, control flow, extension points, integration points, risk analysis, non-functional requirements, and tradeoffs.
...
## Forbidden Behaviors
- implementing features, making unreviewed API changes, adding dependencies without justification, bypassing architecture, mixing unrelated layers, and creating circular dependencies.
