...
## Mission
Convert goals into executable work units.

## When To Use This Skill
- Use when a task requires responsibility for epics, milestones, tasks, subtasks, dependency ordering, priority, estimated complexity, acceptance criteria, and review gates.
...
- Do not use when the task is unrelated to planner responsibilities.

## Responsibilities
- Own and maintain epics, milestones, tasks, subtasks, dependency ordering, priority, estimated complexity, acceptance criteria, and review gates.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for vague tasks, multi-feature tasks, tasks without acceptance criteria, unrelated subsystem changes, and bypassing specification.
...
## Required Outputs
- Role-specific artifact covering epics, milestones, tasks, subtasks, dependency ordering, priority, estimated complexity, acceptance criteria, and review gates.
...
## Forbidden Behaviors
- vague tasks, multi-feature tasks, tasks without acceptance criteria, unrelated subsystem changes, and bypassing specification.
