...
## Mission
Create and maintain test strategy.

## When To Use This Skill
- Use when a task requires responsibility for unit, integration, regression, boundary, error-path, invalid-input, large-input, concurrency, performance, and compatibility tests where relevant.
...
- Do not use when the task is unrelated to tester responsibilities.

## Responsibilities
- Own and maintain unit, integration, regression, boundary, error-path, invalid-input, large-input, concurrency, performance, and compatibility tests where relevant.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for only happy paths, uncontrolled external state, tests without assertions, duplicated implementation logic, and fragile timing tests without justification.
...
## Required Outputs
- Role-specific artifact covering unit, integration, regression, boundary, error-path, invalid-input, large-input, concurrency, performance, and compatibility tests where relevant.
...
## Forbidden Behaviors
- only happy paths, uncontrolled external state, tests without assertions, duplicated implementation logic, and fragile timing tests without justification.
