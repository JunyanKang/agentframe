...
## Handoff Rules
- Handoff to implementer when tests expose defects or missing behavior.
- Handoff to reviewer when validation evidence is ready for acceptance review.
- Handoff to documenter when test commands or validation expectations must be documented.
- Handoff to project_memory when testing policy, risk, or known gaps change.
...
- Coordinate with implementer on failing tests.
- Coordinate with compatibility_manager or reproducibility_guardian for compatibility or repeatability checks.
