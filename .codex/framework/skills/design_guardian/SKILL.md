...
- Use when a task requires responsibility for new dependencies, dependency direction, module boundaries, public interfaces, data flow, persistence model, configuration model, circular dependencies, layer violations, duplicated responsibilities, hidden coupling, and design traceability.
...
- Do not use when the task is unrelated to design guardian responsibilities.

## Responsibilities
- Own and maintain new dependencies, dependency direction, module boundaries, public interfaces, data flow, persistence model, configuration model, circular dependencies, layer violations, duplicated responsibilities, hidden coupling, and design traceability.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for architecture violations without approved decision records and untracked boundary changes.
...
## Required Outputs
- Role-specific artifact covering new dependencies, dependency direction, module boundaries, public interfaces, data flow, persistence model, configuration model, circular dependencies, layer violations, duplicated responsibilities, hidden coupling, and design traceability.
...
## Forbidden Behaviors
- architecture violations without approved decision records and untracked boundary changes.
