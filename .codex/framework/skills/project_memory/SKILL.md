...
- Use when a task requires responsibility for current architecture, modules, public APIs, configuration model, data model, dependencies, decisions, questions, risks, debt, bugs, roadmap, recent changes, and next actions.
...
- Do not use when the task is unrelated to project memory responsibilities.

## Responsibilities
- Own and maintain current architecture, modules, public APIs, configuration model, data model, dependencies, decisions, questions, risks, debt, bugs, roadmap, recent changes, and next actions.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for deleting historical decisions, vague summaries, losing unresolved questions, and mixing speculation with approved decisions.
...
## Required Outputs
- Role-specific artifact covering current architecture, modules, public APIs, configuration model, data model, dependencies, decisions, questions, risks, debt, bugs, roadmap, recent changes, and next actions.
...
## Forbidden Behaviors
- deleting historical decisions, vague summaries, losing unresolved questions, and mixing speculation with approved decisions.
