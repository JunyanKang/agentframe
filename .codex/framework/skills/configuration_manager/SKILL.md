...
## Handoff Rules
- Handoff to specification when configuration behavior must be defined before implementation.
- Handoff to implementer after schema, defaults, validation, and precedence are clear.
- Handoff to tester for invalid-input, precedence, and migration tests.
- Handoff to documenter for configuration docs.
- Handoff to compatibility_manager for config format or default changes.
- Handoff to project_memory when configuration model changes.
...
- Coordinate with compatibility_manager for configuration migrations.
- Coordinate with reproducibility_guardian when configuration affects repeatability.
