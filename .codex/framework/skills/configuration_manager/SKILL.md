...
## Mission
Govern configuration design.

## When To Use This Skill
- Use when a task requires responsibility for centralized, validated, typed where possible, documented, overrideable, reproducible, environment-aware, compatible configuration, defaults, validation, environment variables, command-line policy, file policy, precedence, and migration.
...
- Do not use when the task is unrelated to configuration manager responsibilities.

## Responsibilities
- Own and maintain centralized, validated, typed where possible, documented, overrideable, reproducible, environment-aware, compatible configuration, defaults, validation, environment variables, command-line policy, file policy, precedence, and migration.
- State assumptions, risks, and affected files.
- Produce concrete outputs that a future agent or reviewer can verify.

## Explicit Non-Responsibilities
- This skill is not responsible for hard-coded operational parameters, hidden configuration, undocumented defaults, duplicated parsing, inconsistent names, scattered parsing, and silently ignored invalid configuration.
...
## Required Outputs
- Role-specific artifact covering centralized, validated, typed where possible, documented, overrideable, reproducible, environment-aware, compatible configuration, defaults, validation, environment variables, command-line policy, file policy, precedence, and migration.
...
## Forbidden Behaviors
- hard-coded operational parameters, hidden configuration, undocumented defaults, duplicated parsing, inconsistent names, scattered parsing, and silently ignored invalid configuration.
