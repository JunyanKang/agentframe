...
## Purpose
Define semantic versioning rules, breaking change definitions, minor and patch definitions, prerelease rules, release notes, and changelog requirements.
...
- Major versions contain breaking changes or removed guarantees.
- Minor versions add compatible capability.
- Patch versions clarify or fix existing guidance without changing obligations.
