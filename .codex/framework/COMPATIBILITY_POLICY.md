...
## Purpose
Define compatibility across APIs, configuration, data, plugins, dependencies, runtimes, platforms, and file formats.
...
- Classify every compatibility surface touched by a change.
- Do not drop support silently.
- Provide deprecation and migration guidance for breaking changes.
