...
## Purpose
Define decision-making rules, approval gates, human review, change control, exception handling, and conflict handling.
...
- Architecture, compatibility, public API, release, and data model decisions require recorded rationale.
- Exceptions must state scope, owner, expiry condition, and rollback path.
