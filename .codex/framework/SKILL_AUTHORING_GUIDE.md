...
## Purpose
Define required skill structure, checklist structure, naming conventions, scope boundaries, forbidden skill behaviors, quality requirements, and review process.
...
- Skill names use lowercase words separated by underscores.
- A skill must state what it owns and what it must not do.
- A checklist must include all required checklist categories.
