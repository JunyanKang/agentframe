...
## Purpose
Define how to add new skills, extend existing skills, add templates, avoid conflicts, preserve backward compatibility, and document extension decisions.
...
- Add a skill only when existing skills cannot cover a recurring responsibility.
- Extend existing skills by appending compatible sections when possible.
- New templates must be complete enough to use immediately.
