# AgentFrame Framework

## Purpose
Define the reusable AI-assisted software engineering framework used by future agents to inspect, plan, specify, implement, review, test, document, and maintain repositories.
...
- Use skills as bounded role definitions, not permission to skip inspection.
- Keep framework policy independent of any single project.
